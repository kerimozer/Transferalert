...
export default function WelcomeSignModal({ reservation, onClose }) {
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4 print:p-0 print:bg-surface">
      <div className="bg-surface rounded-2xl shadow-xl w-full max-w-lg print:shadow-none print:rounded-none print:max-w-none">
